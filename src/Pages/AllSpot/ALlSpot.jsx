    ...
    return (
        <div className="max-w-6xl mx-auto mt-4 md:mt-6 lg:mt-8 xl:mt-12">
            <div className="flex justify-between items-center gap-8">
                <div>
                    <h2 className="great-vibes text-3xl font-semibold text-[#131313] mb-2">Hidden Gems: User Picks</h2>
                    <p className="text-sm font-medium text-[#13131366] w-2/3">Explore traveler-recommended destinations. Dive into our user-added spots for unique experiences.</p>
                </div>
