...
const AddSpot = () => {
    ...
    const handleAddTouristSpot = e => {
        ...
        fetch("https://asia-voyage-server.vercel.app/addTouristSpot", {
            method: "POST",
            headers: {
                    ...
                    <div className="p-4 md:p-8 lg:p-12">
                        <form onSubmit={handleAddTouristSpot} className="p-4 md:p-6 lg:-8 bg-[#13131344] rounded-lg drop-shadow-lg shadow-lg backdrop-blur-sm  grid md:grid-cols-2 gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="text" name="touristSpotName" id="touristSpotName" placeholder="Tourist Spot Name" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="countryName" className="text-white text-lg font-medium">Country Name</label>
                                <input type="text" name="countryName" id="countryName" placeholder="Country Name" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="location" className="text-white text-lg font-medium">Location</label>
                                <input type="text" name="location" id="location" placeholder="Location" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="photoUrl" className="text-white text-lg font-medium">Photo Url</label>
                                <input type="text" name="photoUrl" id="photoUrl" placeholder="Photo Url" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="averageCost" className="text-white text-lg font-medium">Average Cost</label>
                                <input type="number" name="averageCost" id="averageCost" placeholder="Average Cost" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="seasonality" className="text-white text-lg font-medium">Seasonality</label>
                                <input type="text" name="seasonality" id="seasonality" placeholder="Seasonality" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="travelTime" className="text-white text-lg font-medium">Travel Time</label>
                                <input type="number" name="travelTime" id="travelTime" placeholder="Travel Time in day" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2">
                                <label htmlFor="visitorsPerYear" className="text-white text-lg font-medium">Visitors Per Year</label>
                                <input type="number" name="visitorsPerYear" id="visitorsPerYear" placeholder="Visitors Per Year" className="px-3 py-2 rounded-lg" required />
                            </div>
                            <div className="flex flex-col gap-2 md:col-span-2">
                                <label htmlFor="shortDescription" className="text-white text-lg font-medium">Short Description</label>
                                <input type="text" name="shortDescription" id="shortDescription" placeholder="Short Description" className="px-3 py-2 rounded-lg" required />
                            </div>
